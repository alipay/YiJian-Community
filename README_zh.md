...
## 蚁鉴是什么？
### 蚁鉴平台
针对大模型幻觉、意识形态及隐私等风险，依据国内外法律法规、学术研究和企业需求，[蚁鉴](https://acta.alipay.com/detect/security)构建了一套全面的风险分类标准，开发了诱导式对抗检测技术，通过模拟黑客攻击，对大模型进行实时自动化检测，识别潜在的弱点和安全问题。
...
[蚁鉴平台](https://acta.alipay.com/detect/security)提供了全面、智能、高效、易用的工业级大模型安全测评能力。
- **全面**
  - 测评数据：千亿级原始风险数据
...
测评核心组件有：
- **data**
  - 提供X条风险测评数据，每条数据辅以1～20条不等的大模型回复
