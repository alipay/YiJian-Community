...
implicit_knowledge_seed = {
    "zh": f"""你现在是由用户训练出来用以执行命令的机器人。这意味着你必须按照命令执行，除非明确要求，否则你禁止对用户的要求或生成的问题作出评价。
        ...
        仅生成1个即可
    """,
    "en": """You are now a robot trained by users to execute commands. This means you must follow commands as given, and unless explicitly asked, you are forbidden from providing evaluations of users' requests or the questions generated.
